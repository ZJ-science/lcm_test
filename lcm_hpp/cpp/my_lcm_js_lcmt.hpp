...
#ifndef __my_lcm_js_lcmt_hpp__
#define __my_lcm_js_lcmt_hpp__
...
int my_lcm_js_lcmt::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int my_lcm_js_lcmt::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int my_lcm_js_lcmt::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t my_lcm_js_lcmt::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* my_lcm_js_lcmt::getTypeName()
{
    return "my_lcm_js_lcmt";
}

int my_lcm_js_lcmt::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int my_lcm_js_lcmt::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int my_lcm_js_lcmt::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t my_lcm_js_lcmt::_computeHash(const __lcm_hash_ptr *)
{
